    ...
    <div class="el-empty">
        <div class="el-empty__image">
            <svg viewBox="0 0 79 86" version="1.1" xmlns="http://www.w3.org/2000/svg"
                ...
                <defs>
                    <linearGradient id="linearGradient-1" x1="38.8503086%" y1="0%" x2="61.1496914%" y2="100%">
                        ...
                        <g id="Group-2" transform="translate(1268.000000, 535.000000)">
                            ...
                            <g id="Group-Copy"
                               transform="translate(34.500000, 31.500000) scale(-1, 1) rotate(-25.000000) translate(-34.500000, -31.500000) translate(7.000000, 10.000000)">
                                ...
                                <rect id="Rectangle-Copy-12" fill="url(#linearGradient-1)"
                            ...
                            <rect id="Rectangle-Copy-15" fill="url(#linearGradient-2)" x="13" y="45" width="40"
                                  height="36"></rect>
                            <g id="Rectangle-Copy-17" transform="translate(53.000000, 45.000000)">
                                ...
                                <polygon id="Rectangle-Copy" fill="#D5D7DE" mask="url(#mask-4)"
        ...
        <div class="el-empty__description"><p v-text="description"></p></div>
    </div>
</template>
